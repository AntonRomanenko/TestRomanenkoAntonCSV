...
<body>
    <form class="container   p-3" action="/file-loader.php" method="post" enctype="multipart/form-data">
    ...
    <div class="container" >
    <a  class=" btn btn-danger" href="/file-loader.php?delete=true">DELETE</a>
    </div>
